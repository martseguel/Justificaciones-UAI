                ...
                <div class="headerUserTransContainer">
                    ...
                    <div class="headerUserOpac">
                        ...
                        <div class="botonSalirIntranet" id="linksToInsert">
                            <a href="./secretaria.php" class="salir" title="Volver">•Volver•</a>
        ...
        <div class="tabDiv">
            ...
            <script>
                function filtrarTabla() {
                    ...
                    var input = document.getElementById("buscar-alumno");
            ...
            <input style="width: 250px; margin-left: 1em;" type="text" id="buscar-alumno" placeholder="Buscar por nombre de alumno" onkeyup="filtrarTabla()">

            <table>
                <caption>Historial Justificaciones</caption>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                    $sql = "SELECT j.*, u.nombre FROM Justificaciones as j INNER JOIN Usuarios as u ON j.alumno_id = u.id";
                    $stmt = mysqli_prepare($link, $sql);
                    mysqli_stmt_execute($stmt);
                    $result = $stmt->get_result();

                    foreach ($result as $r) {
                        echo '<tr data-alumno-id="' . $r["id"] . '"><td data-label="Nombre">' . $r["nombre"] . '</td>';
